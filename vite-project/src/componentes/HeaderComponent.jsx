...
function HeaderComponent(props){ /* Esto quiere decir que va a recibir props */
...
export default HeaderComponent  /* Esto sirve para despues importarlo en otros documentos */